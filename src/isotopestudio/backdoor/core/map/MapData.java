...
public class MapData {
	...
	private Map<String, GameElement> elements = Collections.synchronizedMap(new LinkedHashMap<>());
	private Map<Team, GameElement> team_servers = Collections.synchronizedMap(new LinkedHashMap<>());
